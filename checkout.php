   ...
   if($cart_total == 0){
      ...
      if(mysqli_num_rows($order_query) > 0){
         ...
         foreach ($item_ids as $item_id) {
            mysqli_query($conn, "INSERT INTO `item_ids`(order_id, item_ids) VALUES('$order_id', '$item_id')") or die('query failed');
         }
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>address:</span>
            <input type="text" name="address" required placeholder="e.g. Pepsicola">
         </div>
         <!-- <div class="inputBox">
            <span>city :</span>
